    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid gap-4 md:grid-cols-3 mb-6">
                <div class="rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-500 p-6 text-white shadow-lg">
                    <div class="text-sm text-emerald-50">My Ads</div>
                    <div class="mt-2 text-3xl font-bold">{{ $myAdsCount }}</div>
                </div>
                <div class="rounded-2xl bg-gradient-to-br from-sky-600 to-blue-500 p-6 text-white shadow-lg">
                    <div class="text-sm text-sky-50">Favorites</div>
                ...
                <div class="rounded-2xl bg-gradient-to-br from-amber-500 to-orange-500 p-6 text-white shadow-lg">
                    <div class="text-sm text-amber-50">Reports Sent</div>
                ...
                <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                    <div class="p-6 text-gray-900">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('ads.create') }}" class="btn btn-success btn-sm">Post an Ad</a>
                        </div>
